...
const AdminProductModal = () => {  
  ...
  const {productImage,productName,productDesc,
  productPrice,productCategory,productQty}=productData;
  ...
  const handleProductSubmit=(evt)=>{
    ...
    if(productImage === null){
      setClientSideError('please select image');
      ...
      setClientSideError('Please select a quantiry');
    }else{
